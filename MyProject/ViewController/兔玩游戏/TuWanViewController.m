...
+ (UINavigationController *)standardTuWanNavi{
    ...
    dispatch_once(&onceToken, ^{
        TuWanViewController *vc = [[TuWanViewController alloc]initWithViewControllerClasses:[self viewControllerClasser] andTheirTitles:[self itemNames]];
