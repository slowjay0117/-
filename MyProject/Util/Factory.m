...
+ (void)addBackItemToVC:(UIViewController *)vc{
    ...
    UIBarButtonItem *menuItem = [[UIBarButtonItem alloc]initWithCustomView:btn];
    UIBarButtonItem *spaceItme = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemFixedSpace target:nil action:nil];
    spaceItme.width = -15;
    vc.navigationItem.leftBarButtonItems = @[menuItem, spaceItme];
}
@end
